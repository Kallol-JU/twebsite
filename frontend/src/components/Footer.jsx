...
const Footer = () => {
  return (
    <footer className="w-full border-t border-gray-100 mt-12">
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4 text-xs font-mono text-gray-400">
        {/* Left: Icons */}
        <div className="flex-1 flex items-center justify-center md:justify-start gap-5">
          <a
        ...
        {/* Right: Copyright */}
        <div className="flex-1 text-center md:text-right">&copy; 2026</div>
      </div>
    </footer>
  );
};
